...
[assembly: OwinStartup(typeof(Delat.Startup))]
namespace Delat
{
    public class Startup
    {
        ...
        {
            app.CreatePerOwinContext<DeltaDbContext>(() => new DeltaDbContext());
        ...
        {
            var userStore = new UserStore<IdentityUser>(context.Get<DeltaDbContext>());
    ...
    public class MyOAuthAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
            ...
            OAuthValidateClientAuthenticationContext context)
        {
            ...
            if ( !string.IsNullOrEmpty(clientId) && !string.IsNullOrEmpty(clientSecret))
            {
                ...
                DeltaDbContext dbContext =
                    context.OwinContext.Get<DeltaDbContext>();
